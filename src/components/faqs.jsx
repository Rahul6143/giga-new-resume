  ...
  return (
    <Box
      sx={{
        ...
        justifyContent: "center",
        alignItems: "center",
        padding: { xs: "20px 16px", sm: "40px 20px", md: "60px 20px" },
        color: "#ffffff",
        // background: "linear-gradient(135deg, #0f172a 0%, #1e293b 100%)",
      }}
    >
      <Container maxWidth="xl">
        <Box
          sx={{
            ...
            borderRadius: "20px",
            boxShadow: "0 8px 32px rgba(0,0,0,0.5)",
            padding: { xs: "24px 20px", sm: "30px 24px", md: "40px 32px", lg: "50px 40px" },
            maxWidth: "1200px",
            margin: "0 auto",
          }}
        >
          ...
          <Box
            sx={{
              textAlign: "center",
              marginBottom: { xs: "32px", sm: "40px", md: "50px" },
            }}
          >
            <Typography
              sx={{
          ...
          >
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionSummary 
                  expandIcon={<ExpandMoreIcon sx={{ color: "#f9b600" }} />}
                  sx={{
                ...
                >
                  <Typography
                    sx={{
                      fontWeight: "500 !important",
                      fontSize: { xs: "0.85rem", sm: "0.93rem", md: "1rem" },
                      color: "#f1f5f9 !important",
                      lineHeight: "1.4",
                    }}
                  >
